...
- :link[Fork the repository]{id=https://github.com/Sh3n1in/blog/fork}
- :link[Use this template]{id=https://github.com/Sh3n1in/blog/generate} - In the future, content-free branches will be launched, which do not require deleting and replacing content.
...
```bash
git remote add upstream https://github.com/Sh3n1in/blog.git
```
